...
export default function Home() {
  ...
  return (
    <main className={isDarkMode ? 'min-h-screen bg-black text-white' : 'min-h-screen bg-white text-black'}>
      <SplashCursor />
      {/* Fixed Top Menubar */}
      <motion.nav 
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-white font-bold text-xl tracking-wider">TANYA</div>
              ...
              >
                <svg
                  className={`w-5 h-5 transition-colors duration-300 ${
                    activeSection === item.id ? 'text-black' : 'text-gray-300 group-hover:text-white'
                  }`}
          ...
          <button
            ...
            className="w-10 h-10 rounded-lg flex items-center justify-center bg-gray-800 hover:bg-gray-700 transition-all duration-300"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <motion.div variants={fadeInUp} className="space-y-6">
                ...
                >
                  ...
                  <div>
                    <h4 className="text-white font-medium group-hover:text-gray-200 transition-colors duration-300">WhatsApp</h4>
                    <p className="text-gray-400 text-sm group-hover:text-gray-300 transition-colors duration-300">Chat with me</p>
                  </div>
                </motion.a>
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-white text-black rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 z-40 group"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
